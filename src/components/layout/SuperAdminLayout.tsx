...
export const SuperAdminLayout: React.FC = () => {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-background to-muted/20 flex overflow-hidden">
      ...
      <div className={`
        ...
        lg:translate-x-0 lg:static lg:inset-0 lg:h-full lg:flex lg:flex-col lg:shrink-0
      `}>
        <div className="flex items-center justify-between h-16 px-6 border-b border-border/50 relative flex-shrink-0">
        ...
        <div className="p-4 border-t border-border/50 relative flex-shrink-0">
      ...
      <div className="flex-1 flex flex-col min-w-0 h-full">
        {/* Top header */}
        <header className="h-16 bg-card/95 backdrop-blur-xl border-b border-border/50 flex items-center justify-between px-6 shadow-[var(--shadow-soft)] relative flex-shrink-0">
